...
server {
	...
	error_log  /var/log/nginx/ggimissions.com-error.log;
        access_log /var/log/nginx/ggimissions.com-access.log;
	root /home/francis_web/public/ggimissions.com/public;
